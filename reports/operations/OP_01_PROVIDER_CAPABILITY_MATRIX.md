...
| MetaQuotes | Demo | Pending exact server | Pending | Pending | Pending | Pending | Pending | Pending | Pending | Pending | NEXT_EVALUATION | `reports/operations/providers/MetaQuotes/OP_02_METAQUOTES_DEMO_QUALIFICATION.md` |
