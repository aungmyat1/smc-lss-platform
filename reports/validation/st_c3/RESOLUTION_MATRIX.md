...
| R-18 | `rcr_preregistration.existence_check_floor` | No minimum signal rate | Research required | **COMPUTED 2026-07-26 — signal_rate = 0.0 (0/3339 real GBPUSD M15 windows via `validation/st_c3/evidence_builder.py`); see `R18_EXISTENCE_CHECK_RESULTS.md`** | Low — a Lever-A/B concern, not a blocker for Phases 3-4 | Resolved |
