...
def _positive_bull_windows():
    htf = [
        bar("2026-01-01 00:00", 1.1010, 1.1020, 1.1008, 1.1012),
        bar("2026-01-01 04:00", 1.1012, 1.1030, 1.1010, 1.1025),
        bar("2026-01-01 08:00", 1.1025, 1.1040, 1.1020, 1.1035),
        bar("2026-01-01 12:00", 1.1035, 1.1055, 1.1030, 1.1048),
        bar("2026-01-01 16:00", 1.1048, 1.1050, 1.1020, 1.1028),
        bar("2026-01-01 20:00", 1.1028, 1.1032, 1.1005, 1.1010),
        bar("2026-01-02 00:00", 1.1010, 1.1020, 1.1000, 1.1005),
        bar("2026-01-02 04:00", 1.1005, 1.1015, 1.0997, 1.1002),
        bar("2026-01-02 08:00", 1.1002, 1.1020, 1.1000, 1.1015),
        bar("2026-01-02 12:00", 1.1015, 1.1040, 1.1010, 1.1035),
        bar("2026-01-02 16:00", 1.1035, 1.1068, 1.1030, 1.1062),
        bar("2026-01-02 20:00", 1.1004, 1.1008, 1.0996, 1.1008),
        bar("2026-01-03 00:00", 1.1008, 1.1040, 1.1005, 1.1028),
    ]
    mf = [
