...
def _positive_bull_windows():
    htf = [
        bar("2026-01-01 00:00", 1.1010, 1.1020, 1.1010, 1.1015),
        bar("2026-01-01 04:00", 1.1015, 1.1020, 1.1000, 1.1005),
        bar("2026-01-01 08:00", 1.1005, 1.1010, 1.0990, 1.0995),
        bar("2026-01-01 12:00", 1.0995, 1.1000, 1.0950, 1.0960),
        bar("2026-01-01 16:00", 1.0960, 1.0990, 1.0980, 1.0985),
        bar("2026-01-01 20:00", 1.0985, 1.1000, 1.0990, 1.0995),
        bar("2026-01-02 00:00", 1.0995, 1.1010, 1.1000, 1.1005),
        bar("2026-01-02 04:00", 1.1005, 1.1010, 1.0940, 1.0995),
        bar("2026-01-02 08:00", 1.0965, 1.1015, 1.0960, 1.1000),
    ]
    mf = [
        ...
        bar("2026-01-02 00:45", 1.1010, 1.1011, 1.0992, 1.0994),
    ]
    ltf = [
        bar("2026-01-02 00:00", 1.0990, 1.1000, 1.0988, 1.0995),
        bar("2026-01-02 00:03", 1.0995, 1.1005, 1.0990, 1.1000),
        bar("2026-01-02 00:06", 1.1000, 1.1010, 1.0995, 1.1008),
